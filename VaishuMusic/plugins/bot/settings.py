...
from VaishuMusic.utils.database import (
    add_nonadmin_chat,
    get_authuser,
    get_authuser_names,
    get_playmode,
...
from VaishuMusic.utils.decorators.admins import ActualAdminCB
from VaishuMusic.utils.decorators.language import language, languageCB
from VaishuMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from VaishuMusic.utils.inline.start import private_panel
...
async def show_bot_info(c: app, q: CallbackQuery):
    start = time.time()
    x = await c.send_message(q.message.chat.id, "ᴄʜᴇᴄᴋɪɴɢ ᴘʟᴇᴀsᴇ ᴡᴀɪᴛ...")
